                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('students.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('age') }}" required autocomplete="name" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6 ">
                                <div class="form-check-inline"> 
                                    <input type="radio" class="form-check-input @error('gender') is-invalid @enderror" id="radio1" name="gender" value="Male"> Male
                                    <label class="form-check-label" for="radio1"></label>
                                    <input type="radio" class="form-check-input @error('gender') is-invalid @enderror" id="radio2" name="gender" value="Female"> Female
